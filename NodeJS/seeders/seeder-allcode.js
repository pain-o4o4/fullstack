...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        const data = [
            ...
            { type: 'TIME', keyMap: 'T4', valueEn: '11:00 AM - 12:00 PM', valueVi: '11:00 - 12:00' },
            ...
            { type: 'PROVINCE', keyMap: 'PRO4', valueEn: 'Can Tho', valueVi: 'Cần Thơ' },
            { type: 'PROVINCE', keyMap: 'PRO5', valueEn: 'Binh Duong', valueVi: 'Bình Dương' },
            { type: 'PROVINCE', keyMap: 'PRO6', valueEn: 'Dong Nai', valueVi: 'Đồng Nai' },
            { type: 'PROVINCE', keyMap: 'PRO7', valueEn: 'Quang Ninh', valueVi: 'Quảng Ninh' },
